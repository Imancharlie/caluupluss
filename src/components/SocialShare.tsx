...
const SocialShare = ({ title, description, image, url }: SocialShareProps) => {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <motion.button
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        className="p-2 text-white/80 hover:text-white transition-colors bg-red-500/20 hover:bg-red-500/30 rounded-full"
