...
import { Bell, Megaphone, Plus, Trash2, Search } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Create and manage notifications and announcements</p>
          </div>
        </div>
        ...
        <Card className="bg-white border-gray-200 shadow-md">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Filter by title or type</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                <Input className="pl-9" placeholder="Search notifications..." />
              </div>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
          <Card className="bg-white border-gray-200 shadow-sm lg:col-span-2">
            <CardHeader className="pb-3">
              ...
              <CardDescription>List (wire to API next)</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Actions for selected item</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-2">
              <Button variant="outline"><Bell className="w-4 h-4 mr-1" /> Mark Read</Button>
